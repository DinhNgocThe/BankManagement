...
namespace BankManagement.Model
{
	internal class Staff
	{
        ...
        public Staff(int id, string name, string username, string password, string workingBranch, string jobPosition, string photoPath, string email, string status, string role)
        {
            this.id = id;
            this.name = name;
            this.username = username;
